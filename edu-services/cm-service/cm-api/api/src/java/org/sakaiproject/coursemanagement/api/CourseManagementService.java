...
public interface CourseManagementService {
	...
	/**
	 * Finds all of the course offerings associated to an academic career that are current for any given
	 * academic session (regardless of the courseOffering's start and end dates).
	 *
	 * @param acadCareer
	 * @param academicSessionEid
	...
	/** Finds all of the course offerings associated to an academic career
	 *
	 * @param acadCareer
	 * @return The set of course offerings
	 * @throws IdNotFoundException
