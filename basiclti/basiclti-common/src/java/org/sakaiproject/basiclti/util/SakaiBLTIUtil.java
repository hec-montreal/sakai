	...
	public static final String LTI1_ANON_PATH = "/imsoidc/lti11/";
		...
		*/
		...
		public static boolean sakaiInfo(Properties props, Placement placement, ResourceLoader rb, String selectedSection) {
			...
			log.debug("ContextID={} placement={} placement title={} section={}", context, placement.getId(), placement.getTitle(), selectedSection);
		...
		public static void addSiteInfo(Properties props, Site site) {
			addSiteInfo(props, site, null);
		}

		public static void addSiteInfo(Properties props, Site site, String selectedSection) {
			if (site != null) {
		...
		public static boolean sakaiInfo(Properties props, String context, String placementId, ResourceLoader rb) {
			return sakaiInfo(props, context, placementId, rb, null);
		}
		...
		public static boolean sakaiInfo(Properties props, String context, String placementId, ResourceLoader rb, String selectedSection) {
			...
			addSiteInfo(props, site, selectedSection);
