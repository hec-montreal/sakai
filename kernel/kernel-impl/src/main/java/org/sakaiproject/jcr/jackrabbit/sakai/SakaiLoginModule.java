/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/kernel/tags/kernel-1.2.6/kernel-impl/src/main/java/org/sakaiproject/jcr/jackrabbit/sakai/SakaiLoginModule.java $
			...
			if (creds != null)
			{
				if (creds instanceof SimpleCredentials)
				{
                  ...
                  Authentication auth = authenticationManager.authenticate( 
                        new IdPwEvidence( sc.getUserID(), new String(sc.getPassword()), null ) );
