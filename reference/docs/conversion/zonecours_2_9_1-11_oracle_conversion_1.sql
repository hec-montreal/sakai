...
--CREATE INDEX SMB_SEARCH on SAKAI_MESSAGE_BUNDLE (BASENAME, MODULE_NAME, LOCALE, PROP_NAME);  --HEC - index existe deja
...
-- HEC nous n'avons pas d'objet SAM_PUBATTACHMENT_ID_S en production (ça affecte sakai 10.1)
--declare 
--init_value number; 
--bad_object number; 
--begin 
...
ALTER TABLE SAM_QUESTIONPOOLITEM_T ADD (ITEMID_TMP NUMBER(19));
UPDATE SAM_QUESTIONPOOLITEM_T SET ITEMID_TMP = ITEMID;
ALTER TABLE SAM_QUESTIONPOOLITEM_T DROP COLUMN ITEMID CASCADE CONSTRAINTS;
ALTER TABLE SAM_QUESTIONPOOLITEM_T RENAME COLUMN ITEMID_TMP TO ITEMID; 
--recreate idexes/constraints
CREATE UNIQUE INDEX SYS_C0019994 ON SAM_QUESTIONPOOLITEM_T (QUESTIONPOOLID, ITEMID); --HEC specific index name
ALTER TABLE SAM_QUESTIONPOOLITEM_T MODIFY (ITEMID NOT NULL ENABLE);
