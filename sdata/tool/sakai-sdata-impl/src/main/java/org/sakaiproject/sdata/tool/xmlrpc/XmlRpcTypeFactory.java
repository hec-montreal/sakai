/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/tfd/branches/sdata-ct25x/tool/sakai-sdata-impl/src/main/java/org/sakaiproject/sdata/tool/xmlrpc/XmlRpcTypeFactory.java $
 * $Id: XmlRpcTypeFactory.java 45722 2008-02-19 11:56:15Z ian@caret.cam.ac.uk $
 ***********************************************************************************
 *
...
public class XmlRpcTypeFactory implements TypeFactory
{
	 ...
	 */
	public XmlRpcTypeFactory(XmlRpcStreamRequestConfig config)
	{
		this.config = config;
	}
